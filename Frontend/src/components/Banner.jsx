...
function Banner({ theme }) {
  return (
    <>
    <div
     className={`max-w-screen-2xl container mx-auto px-4 md:px-20 flex flex-col-reverse md:flex-row items-center pb-10 ${theme === "dark" ? "bg-gray-800" : "bg-white"}`}
    ...
    >
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center mt-12 md:mt-32">
        <img
          src="../../public/image/RR2.png"  // Make sure your image path is correct
          alt="Banner"
